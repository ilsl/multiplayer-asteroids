...
from multiplayerasteroids import GameObject, Spaceship, Missile, Rock, MyGame
#from game import PhotonTorpedo, Asteroid, SpaceShip
import originalTurtles
class Client(ConnectionListener, Spaceship, Missile, Rock, MyGame):
#class Client(ConnectionListener, PhotonTorpedo, Asteroid, SpaceShip):
    def __init__(self, host, port):
        self.Connect((host, port))
        self.players = {}
        # PhotonTorpedo.__init__(self)
    ...
    def moveUp(self, e):
        connection.Send({"action": "moveup"})

    def moveDown(self, e):
        connection.Send({"action": "movedown"})

    def moveRight(self, e):
        connection.Send({"action": "moveright"})

    def moveLeft(self, e):
        connection.Send({"action": "moveleft"})
